-- ============================================================
--  NUTECH BLOOD BANK — Seed Data (PostgreSQL / Supabase)
-- ============================================================

-- Blood Groups
INSERT INTO blood_groups (group_name, rh_factor, abo_type, description) VALUES
  ('A+', '+', 'A',  'Most common after O+'),
  ('A-', '-', 'A',  'Universal plasma donor'),
  ('B+', '+', 'B',  'Second most common'),
  ('B-', '-', 'B',  'Rare type'),
  ('O+', '+', 'O',  'Universal RBC donor for + types'),
  ('O-', '-', 'O',  'Universal emergency donor'),
...
INSERT INTO blood_requests (patient_id,hospital_id,blood_group_id,units_requested,request_date,urgency_level,status,notes,approved_by,approved_date) VALUES
  (1,3,3,2.0,'2026-04-28 08:00:00+05','high','fulfilled','Monthly thalassaemia transfusion',5,'2026-04-28 08:45:00+05'),
  (2,1,5,1.5,'2026-04-27 14:30:00+05','medium','fulfilled','Post-op anaemia correction',1,'2026-04-27 15:00:00+05'),
  (4,2,6,3.0,'2026-04-25 02:15:00+05','critical','fulfilled','RTA with severe haemorrhage — EMERGENCY',1,'2026-04-25 02:20:00+05'),
  (5,2,2,2.0,'2026-04-24 11:45:00+05','high','approved','Aplastic anaemia protocol',1,'2026-04-24 12:00:00+05'),
  (6,6,4,1.0,'2026-04-23 09:30:00+05','low','pending','Pre-surgical crossmatch',null,null),
  (8,3,7,2.0,'2026-04-21 09:00:00+05','high','approved','Sickle cell vaso-occlusive crisis',5,'2026-04-21 09:15:00+05'),
  (12,9,5,2.5,'2026-04-17 04:30:00+05','critical','fulfilled','PPH — maternity emergency',1,'2026-04-17 04:35:00+05'),
  (15,1,5,4.0,'2026-04-14 23:45:00+05','critical','fulfilled','Spleen rupture — massive transfusion',1,'2026-04-14 23:50:00+05'),
  (17,6,3,2.0,'2026-04-12 11:00:00+05','medium','pending','MDS support — regular protocol',null,null),
  (19,2,6,5.0,'2026-04-10 01:00:00+05','critical','fulfilled','Polytrauma MVA — massive transfusion protocol',1,'2026-04-10 01:05:00+05')
ON CONFLICT DO NOTHING;

-- Donations
INSERT INTO donations (donor_id,bank_id,staff_id,blood_group_id,donation_date,units_donated,hemoglobin_level,blood_pressure,status) VALUES
  (1,1,3,5,'2025-12-01 09:30:00+05',1.0,13.2,'118/76','completed'),
  (2,1,3,1,'2025-11-15 10:15:00+05',1.0,14.8,'122/80','completed'),
  (3,2,4,3,'2025-10-20 11:00:00+05',1.0,12.9,'115/75','completed'),
  (4,3,5,6,'2025-09-10 08:45:00+05',1.0,15.1,'120/78','completed'),
  (5,2,4,2,'2025-08-25 14:30:00+05',1.0,13.5,'112/72','completed'),
  (6,5,7,7,'2025-07-14 09:00:00+05',1.0,14.2,'124/82','completed'),
  (7,3,5,4,'2025-11-01 10:45:00+05',1.0,13.8,'118/76','completed'),
  (8,1,3,5,'2025-10-05 11:30:00+05',1.0,14.0,'120/80','completed'),
  (9,2,4,8,'2025-09-30 09:15:00+05',1.0,12.7,'110/70','completed'),
  (10,2,4,1,'2025-11-20 10:00:00+05',1.0,15.6,'126/84','completed'),
  (11,1,3,3,'2025-08-10 13:45:00+05',1.0,13.1,'116/74','completed'),
  (12,2,4,6,'2025-10-18 08:30:00+05',1.0,14.5,'122/80','completed'),
  (13,3,5,5,'2025-11-05 11:00:00+05',1.0,13.6,'119/77','completed'),
  (14,3,5,2,'2025-07-28 09:30:00+05',1.0,14.9,'124/82','completed'),
  (15,4,6,4,'2025-10-01 10:15:00+05',1.0,13.3,'115/75','pending'),
  (16,5,7,7,'2025-09-15 08:00:00+05',1.0,15.0,'128/84','completed'),
  (17,3,5,1,'2025-08-22 14:00:00+05',1.0,13.0,'113/73','completed'),
  (18,1,3,3,'2025-11-10 11:45:00+05',1.0,14.3,'120/78','completed'),
  (19,2,4,6,'2025-10-25 09:00:00+05',1.0,13.7,'117/75','completed'),
  (20,1,3,5,'2025-11-28 10:30:00+05',1.0,15.4,'122/80','completed')
ON CONFLICT DO NOTHING;
